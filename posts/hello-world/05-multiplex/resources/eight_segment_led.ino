...
class EightSegmentLEDCommonAnode : public Runnable {
    ...
    // common anode digital IO pin (used for multiplexing)
    byte panode;
    // digital IO pins
    byte p7a;
    byte p6b;
...
public:
    ...
    EightSegmentLEDCommonAnode(
            CharacterMap *characterMap,
            byte ledPin03_Anode_digitalIOPin,
            ...
            :
            characterMap(characterMap),
            panode(ledPin03_Anode_digitalIOPin),
...
class MultiSegmentDisplay : Runnable {
